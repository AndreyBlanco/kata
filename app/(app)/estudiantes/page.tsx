      ...
      <div className="bg-white border-b px-4 py-4">
        <div className="max-w-lg mx-auto flex items-center justify-between">
          ...
          <Link
            ...
            className="rounded-lg bg-kata-primary px-4 py-2 text-sm font-medium
                       text-white transition-colors hover:bg-kata-primary-dark"
          >
            + Nuevo
          </Link>
        </div>
        ...
        {students.length === 0 ? (
          ...
          <div className="space-y-3">
            {students.map((student) => (
              <Link
                key={student.id}
                href={`/estudiantes/${student.id}/expediente`}
